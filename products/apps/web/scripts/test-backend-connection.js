...
async function testBackendConnection() {
  ...
  console.log('2⃣ Testing collaboration metrics endpoint...')
  try {
  ...
  console.log('3⃣ Testing Next.js API route (proxy)...')
  try {
    ...
    if (proxyResponse.ok) {
      ...
      if (dataSource === 'fallback') {
        console.log(`     Using fallback data (backend unavailable)`)
      }
      console.log('')
    } else {
