...
**⚠️ Important**: Ports are internal Docker network only. All services are accessed via the unified gateway at `POST /api/v1/guards/process`.
...
## 🛡️ Individual Service Documentation
