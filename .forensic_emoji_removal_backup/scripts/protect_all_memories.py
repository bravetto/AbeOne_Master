...
class MemoryProtectionSystem:
    ...
    def verify_logging_hooks(self):
        ...
        if all_ok:
            ...
            print("   ⚠️  Some logging hooks have issues:")
    ...
    def setup_monitoring(self):
        ...
        print("👁️  Setting up memory monitoring...")
...
'''
    ...
    def fix_logging_issues(self):
        ...
        if not os.access(LOGS_DIR, os.W_OK):
            print(f"   ⚠️  Logs directory not writable: {LOGS_DIR}")
        
        if not os.access(CDF_DIR, os.W_OK):
            print(f"   ⚠️  CDF directory not writable: {CDF_DIR}")
