#!/usr/bin/env python3
"""
Health check script for TokenGuard microservice.
...
def check_health(base_url: str, timeout: int = 5) -> Dict[str, Any]:
    """
    Check the health of the TokenGuard service.
...
def main() -> Any:
    ...
    parser = argparse.ArgumentParser(description="Health check for TokenGuard microservice")
    parser.add_argument(
        "--url", 
