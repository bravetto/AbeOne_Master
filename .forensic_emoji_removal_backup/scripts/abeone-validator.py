...
def validate_code():
    ...
    if not gateway_path:
        print("  ⚠️  Gateway path not found, skipping import tests")
        return
    ...
    try:
        ...
        try:
            ...
            print(f"  ⚠️  Stripe service import failed: {e}")
        except Exception as e:
            print(f"  ⚠️  Stripe service import error: {e}")
        ...
        try:
            ...
            print(f"  ⚠️  Guards router import failed: {e}")
        except Exception as e:
            print(f"  ⚠️  Guards router import error: {e}")
...
def validate_state():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("  ⚠️  Gateway service not responding")
    except:
        print("  ⚠️  Gateway service not running")
