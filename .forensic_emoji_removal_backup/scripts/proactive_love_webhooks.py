...
class ProactiveLoveWebhooks:
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    print("⚠️  UPTC not available (module not found)")
                    self.uptc_core = None
                    return
            ...
            print(f"⚠️  UPTC initialization failed: {e}")
            self.uptc_core = None
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    print("⚠️  AgentCapability not available, skipping UPTC registration")
                    return
            ...
            print(f"⚠️  UPTC registration failed: {e}")
    ...
    def _store_in_cdf(self, relationship: str, messages: List[Dict]) -> Optional[Path]:
        ...
        try:
            ...
            print(f"⚠️  CDF storage failed: {e}")
            return None
    ...
    def _publish_to_uptc(self, relationship: str, message_count: int, cdf_path: Optional[Path]):
        ...
        try:
            ...
            print(f"⚠️  UPTC publish failed: {e}")
