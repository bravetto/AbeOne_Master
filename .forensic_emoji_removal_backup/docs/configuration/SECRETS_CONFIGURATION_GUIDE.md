...
```json
{
  ...
  "REDIS_URL": "redis=REPLACE_MEhost:port/database",
...
POSTGRES_PASSWORD=REPLACE_ME rand -base64 32)
...
cat > secrets.json << EOF
{
  ...
  "REDIS_URL": "redis=REPLACE_MEyour-redis-host:6379/0",
...
NEW_DB_PASSWORD=REPLACE_ME rand -base64 32)
