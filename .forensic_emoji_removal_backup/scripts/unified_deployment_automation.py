...
class UnifiedDeploymentAutomation:
    ...
    def deploy_cloudflare(self) -> bool:
        ...
        if not self.check_cloudflare_status():
            print("⚠️  Cloudflare appears to be experiencing issues")
        ...
        try:
            with sync_playwright() as p:
                ...
                try:
                    ...
                    print("⚠️  Page load timeout - trying dashboard...")
                ...
                if "sign in" in page_content or "log in" in page_content:
                    print("⚠️  Please log in to Vercel in the browser")
                ...
                try:
                    ...
                    if not imported:
                        print("⚠️  Could not find import button automatically")
                ...
                try:
                    ...
                    print("⚠️  Could not auto-fill project name")
                ...
                try:
                    ...
                    if not deployed:
                        print("⚠️  Could not find deploy button automatically")
        ...
        for platform in platforms:
            if platform == 'cloudflare':
                ...
                if success:
                    ...
                    print("\n⚠️  Cloudflare deployment failed, trying Vercel...")
                    time.sleep(2)
