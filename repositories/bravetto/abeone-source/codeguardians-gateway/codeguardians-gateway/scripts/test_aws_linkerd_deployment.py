...
Usage:
    python scripts/test_aws_linkerd_deployment.py --environment production
"""
...
class AWSLinkerdTester:
    ...
    async def test_aws_environment_variables(self) -> Dict:
    ...
    async def run_all_tests(self) -> Dict:
        ...
        print(f"\n{BOLD}{CYAN}  AWS/Linkerd Deployment Readiness Validation{RESET}\n")
        ...
        tests = [
            ...
            self.test_aws_environment_variables,
