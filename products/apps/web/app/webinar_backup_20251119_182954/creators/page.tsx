...
/**
 * CREATOR WEBINAR LANDING PAGE
 * 
 * Conversion-Optimized Landing Page for Creators/Vibe Coders
 * Built with validated patterns from WEBINAR_CONVERSION_OPTIMIZATION_MASTER_SYNTHESIS.md
 * 
 * Target ICP: Creatives/Vibe Coders (aesthetic-driven, FOMO-driven)
 * 
...
export default function CreatorWebinarPage() {
  ...
  // Force creator ICP for this page
  const icp = 'creative'
