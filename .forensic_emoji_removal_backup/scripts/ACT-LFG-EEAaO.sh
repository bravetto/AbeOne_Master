...
if [ -f "$WORKSPACE_ROOT/.drift-operational.json" ]; then
    ...
    echo "⚠️  Operational status file missing - creating..."
...
if [ -d "$WORKSPACE_ROOT/.git" ]; then
    ...
    echo "   ⚠️  No .git directory - skipping git hooks"
fi
...
echo "🛡️  Executing Gentle Drift Guardian..."
...
echo "🛡️  Executing Boundary Validation..."
...
echo "🛡️  Executing Import Validation..."
