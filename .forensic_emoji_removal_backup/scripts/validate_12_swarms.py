...
class SwarmValidator:
    ...
    def discover_all_swarms(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"⚠️  Error discovering frequency swarms: {e}")
        ...
        try:
            ...
            print(f"⚠️  Error discovering guardian swarm: {e}")
        ...
        try:
            ...
            print(f"⚠️  Error discovering role swarms: {e}")
        ...
        try:
            ...
            print(f"⚠️  Error discovering synthesis swarm: {e}")
        ...
        try:
            ...
            print(f"⚠️  Error discovering convergence orchestrator swarm: {e}")
...
async def main():
    ...
    if results['discovered_swarms'] >= 12:
        ...
        print(f"⚠️  Swarm Count: {results['discovered_swarms']}/12 (Need {12 - results['discovered_swarms']} more)")
    ...
    if results['size_validation']:
        ...
        if size < 3.0:
            print(f"⚠️  Codebase Size: {size:.2f} GB (Below expected range: 3.0-10.0 GB)")
        else:
            print(f"⚠️  Codebase Size: {size:.2f} GB (Above expected range: 3.0-10.0 GB)")
    ...
    if results['validation_passed']:
        ...
        print()
        print("=" * 80)
        print(f"⚠️  VALIDATION INCOMPLETE - {results['discovered_swarms']}/12 SWARMS DISCOVERED")
        print("=" * 80)
        print()
