...
class ComprehensiveTestRunner:
    ...
    async def _test_telemetry_setup(self) -> None:
        ...
        try:
            ...
            if health["tracer_configured"] and health["meter_configured"]:
                ...
                logger.warning(" Telemetry setup partially configured")
    ...
    async def _test_guard_services(self) -> None:
        ...
        try:
            ...
            if success:
                ...
                logger.warning(f" Guard services test partially passed. Expected: {expected_services}, Got: {actual_services}")
    ...
    async def _test_api_endpoints(self) -> None:
        ...
        if success:
            ...
            logger.warning(f" API endpoints test partially passed. Failed: {failed_endpoints}")
    ...
    async def _test_llm_integration(self) -> None:
        ...
        try:
            ...
            if success:
                ...
                logger.warning(" LLM integration test failed")
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                if success:
                    ...
                    logger.warning(f" Documentation test failed with {high_severity_issues} high severity issues")
            else:
    ...
    async def _test_docker_containers(self) -> None:
        ...
        try:
            ...
            if success:
                ...
                logger.warning(" No service containers found")
