...
echo "🛡️  Setting up always-visible drift status..."
echo ""
...
cat > "$WORKSPACE_ROOT/.vscode/tasks.json" << 'EOF'
{
  ...
  "tasks": [
    {
      "label": "🛡️ Update Drift Guardian Status",
      "type": "shell",
    ...
    {
      "label": "🛡️ Watch Drift Guardian (Auto-Update)",
      "type": "shell",
...
echo "  3. Select: '🛡️ Watch Drift Guardian (Auto-Update)'"
echo ""
