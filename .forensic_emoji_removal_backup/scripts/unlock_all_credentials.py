...
class CredentialUnlocker:
    ...
    def pull_from_1password(self) -> Dict[str, Any]:
        ...
        if not self.check_1password_signed_in():
            print("⚠️  Not signed in to 1Password")
        ...
        try:
            ...
            print("⚠️  1Password CLI not installed")
        except subprocess.TimeoutExpired:
            print("⚠️  1Password CLI timeout")
        except json.JSONDecodeError as e:
            print(f"⚠️  Error parsing 1Password output: {e}")
        except Exception as e:
            print(f"⚠️  Error accessing 1Password: {e}")
            import traceback
            traceback.print_exc()
