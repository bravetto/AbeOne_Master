...
class ReliabilityMetrics:
    ...
    def _setup_prometheus_metrics(self):
        ...
        self.request_duration = Histogram(
            'trust_guard_request_duration_seconds',
        ...
        self.pattern_detections_total = Counter(
            'trust_guard_pattern_detections_total',
        ...
        self.pattern_detection_duration = Histogram(
            'trust_guard_pattern_detection_duration_seconds',
        ...
        self.validation_duration = Histogram(
            'trust_guard_validation_duration_seconds',
        ...
        self.pattern_accuracy = Gauge(
            'trust_guard_pattern_accuracy_ratio',
