...
# With JSON output
python scripts/test_aws_nlb_failure_patterns.py --url http://localhost:9001 --json
```
...
python scripts/test_aws_linkerd_integration_patterns.py --url http://localhost:9001 --no-linkerd
```
...
python scripts/test_aws_linkerd_deployment.py --url http://localhost:8000 --json > aws_results.json
...
| `test_aws_nlb_failure_patterns.py` | Detect NLB patterns | `http://localhost:9001` | No |
| `test_linkerd_failure_patterns.py` | Detect Linkerd patterns | `http://localhost:9001` | No |
| `test_aws_linkerd_integration_patterns.py` | Detect integration patterns | `http://localhost:9001` | No |
...
| `test_aws_linkerd_deployment.py` | Validate AWS/Linkerd deployment | `http://localhost:8000` | No |
