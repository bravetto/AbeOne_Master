...
class DNSPropagationMonitor:
    ...
    def monitor(
            ...
            if current_value:
                ...
                if self.expected_target.lower() in current_value_lower:
                    ...
                    if success_count == total_count:
                        ...
                        print(f"⏱️  Time to propagate: {elapsed}s")
                        return True
                    else:
                        print(f"⏳ Still propagating... ({success_count}/{total_count})")
                else:
                    print(f"⚠️  Target mismatch: expected {self.expected_target}, got {current_value}")
            else:
        ...
        print("\n" + "=" * 60)
        print(f"⚠️  DNS propagation not complete after {max_wait}s")
    ...
    if args.test:
        ...
        if result:
            ...
            if args.expected_target.lower() in result.lower():
                ...
                print(f"⚠️  Target mismatch: expected {args.expected_target}")
        else:
