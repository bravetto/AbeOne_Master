...
class RuntimeValidator:
    ...
    def test_aws_secrets_availability(self):
    ...
    def test_aws_secrets_loading(self):
    ...
    def run_all_tests(self):
        ...
        aws_available = self.test_aws_secrets_availability()
        if aws_available:
            secrets = self.test_aws_secrets_loading()
        else:
            print("  AWS Secrets Manager not available, skipping secrets tests")
