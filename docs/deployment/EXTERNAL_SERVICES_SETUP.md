...
REPLACE_MEep-xxx.us-east-1.aws.neon.tech/neondb?sslmode=require
...
REPLACE_MEep-xxx-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require
```

### 6. Test Database Connection
```bash
# Test connection
psql "REPLACE_MEep-xxx.us-east-1.aws.neon.tech/neondb?sslmode=require" \
  -c "SELECT version();"
...
cat > production-secrets.json << EOF
{
  ...
  "REDIS_URL": "REPLACE_MEyour-elasticache-endpoint:6379/0",
