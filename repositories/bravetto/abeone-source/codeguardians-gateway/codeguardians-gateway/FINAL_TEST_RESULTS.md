...
####  Tests Requiring Authentication Tokens:
...
3.  **Optional**: Add `/ready` endpoint for Kubernetes readiness probe
4.  **Optional**: Add `/alive` endpoint for Kubernetes liveness probe
