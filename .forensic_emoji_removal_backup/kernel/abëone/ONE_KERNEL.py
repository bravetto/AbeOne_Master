        ...
        with self._lock:
            ...
            try:
                ...
                try:
                    ...
                    print(f"⚠️ Warning: Failed to register Guardian Two: {e}")
                ...
                try:
                    ...
                    print(f"⚠️ Warning: Failed to register Guardian Three: {e}")
                ...
                try:
                    ...
                    print(f"⚠️ Warning: Failed to register Guardian Five: {e}")
