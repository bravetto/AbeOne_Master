...
python scripts/test_aws_linkerd_deployment.py --url http://api.example.com

# Staging environment with Linkerd disabled
python scripts/test_aws_linkerd_deployment.py --url http://staging-api.example.com --environment staging --no-linkerd

# Custom namespace
python scripts/test_aws_linkerd_deployment.py --url http://api.example.com --namespace production
```
...
# Run tests
python scripts/test_production_readiness.py --url http://localhost:8000
python scripts/test_aws_linkerd_deployment.py --url http://localhost:8000 --namespace production
```
