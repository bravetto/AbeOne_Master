...
from .core import DataSample, AnalysisResult, MitigationAction, Report
...
from .config_validator import validate_config, get_config_validation_report, PoisonGuardConfig
...
def load_config(config_path='config.yaml', required=False):
    ...
    try:
        ...
        if required:
            ...
            return PoisonGuardConfig()  # Return default config
