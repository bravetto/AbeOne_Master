...
|---------|---------------|------------|
| `flow_table_exhaustion` | `REPLACE_ME.py` | Connection timing, timeouts |
| `circuit_breaker` | `test_linkerd_failure_patterns.py` | Failure streaks, circuit breaker |
| `target_group_saturation` | `REPLACE_ME.py` | 503 errors, saturation |
| `connection_refused` | `test_linkerd_failure_patterns.py` | Connection errors, OS 111 |
| `keep_alive_mismatch` | `REPLACE_ME.py` | Header analysis |
...
| `timeout_cascade` | `REPLACE_ME.py` | Combined patterns |
...
python scripts/test_linkerd_failure_patterns.py --url http://localhost:9001
python scripts/REPLACE_ME.py --url http://localhost:9002
```
