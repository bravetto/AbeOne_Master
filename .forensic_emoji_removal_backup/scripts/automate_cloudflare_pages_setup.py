...
class CloudflarePagesAutomation:
    ...
    def __init__(self, api_token: Optional[str] = None, account_id: Optional[str] = None):
        ...
        if AUTH_AVAILABLE and not api_token:
            try:
                ...
                print(f"⚠️  ZERO Effort auth failed: {e}")
    ...
    def list_github_repos(self) -> list[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"⚠️  Could not list GitHub repos: {e}")
    ...
    def create_project(
        ...
        if github_repo:
            ...
            print(f"⚠️  GitHub repository '{repo_name}' not found in connected repos")
    ...
    def trigger_deployment(self, project_name: str) -> bool:
        ...
        try:
            ...
            if data.get("success"):
                ...
                print("⚠️  Deployment trigger failed (project may auto-deploy)")
                return False
