...
5. **`scripts/test_aws_nlb_failure_patterns.py`** (21KB)
   - AWS NLB pattern detection
   
6. **`scripts/test_linkerd_failure_patterns.py`** (20KB)
   - Linkerd pattern detection
   
7. **`scripts/test_aws_linkerd_integration_patterns.py`** (18KB)
...
10. **`scripts/test_aws_linkerd_deployment.py`** (19KB)
...
|---------|-----------------|------------------|-------------------|
| Flow Table Exhaustion | `flow_table_exhaustion` | `test_aws_nlb_failure_patterns.py` | Silent connection rejections |
| Circuit Breaker | `circuit_breaker` | `test_linkerd_failure_patterns.py` | Service unavailable |
| Timeout Cascade | `timeout_cascade` | `test_aws_linkerd_integration_patterns.py` | Cascading failures |
| Stream Exhaustion | `stream_exhaustion` | `test_linkerd_failure_patterns.py` | HTTP/2 limit exceeded |
| Target Group Saturation | `target_group_saturation` | `test_aws_nlb_failure_patterns.py` | 503 Service Unavailable |
...
-  **Action**: Review recommendations, apply mitigations
