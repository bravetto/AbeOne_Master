...
class MasterValidationSystem:
    ...
    def _print_summary(self, report: Dict[str, Any]):
        ...
        print(f"\n⏱️  Execution Time: {report['execution_time_seconds']:.2f}s")
