...
### 1. **Async/Sync Blocking Issue**  HIGH PRIORITY
...
### 2. **ThreadPoolExecutor Implementation**  HIGH PRIORITY
...
### 3. **Lambda Closure Issues**  MEDIUM PRIORITY
...
### 4. **Event Loop Access**  MEDIUM PRIORITY
...
### 5. **Authentication Dependency Chain**  LOW PRIORITY (probably not the issue)
...
### 6. **Synchronous Operations in Auth Flow**  LOW PRIORITY
...
### 11. **Missing Return Statement**  CHECK NEEDED
...
### 12. **Request Body Parsing**  LOW PRIORITY
