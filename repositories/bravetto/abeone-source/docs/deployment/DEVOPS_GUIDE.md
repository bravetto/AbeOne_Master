...
```bash
SECRET_KEY=your-64-character-secure-random-string-here
ALLOWED_ORIGINS=https://yourdomain.com
...
REDIS_URL=REPLACE_MEelasticache-endpoint:6379/0
...
POSTGRES_REPLACE_ME rand -hex 16) # 32 characters
REDIS_REPLACE_ME rand -hex 16)    # 32 characters
...
| `REDIS_URL` | Full Redis connection | URL format | `REPLACE_MEhost:6379/0` |
...
NEW_POSTGRES_REPLACE_ME rand -hex 16)
NEW_REDIS_REPLACE_ME rand -hex 16)
