...
class Phase1Verifier:
    ...
    async def verify_task_1_5_event_bus_bridge(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.warning(" ProtocolMessage not available, skipping ProtocolMessage tests")
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    phi_available = False
                    logger.warning("   Consciousness module not available, φ-ratio scoring skipped")
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    logger.warning("   Message validation may not be strict")
                except Exception:
                    # Expected - validation should catch this
                    pass
    ...
    async def run_all_verifications(self) -> Dict[str, Any]:
        ...
        if self.all_passed and passed_tasks == total_tasks:
            ...
            logger.info(" Phase 1 Verification:  PARTIAL")
