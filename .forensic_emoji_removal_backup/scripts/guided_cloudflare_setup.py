...
class GuidedCloudflareSetup:
    ...
    def execute(self) -> bool:
        ...
        if not PLAYWRIGHT_AVAILABLE:
            print("\n⚠️  Playwright not available - using browser-only mode")
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                try:
                    ...
                    print("⚠️  Timeout - trying dashboard first...")
                ...
                if self._is_cloudflare_challenge(page):
                    ...
                    if self._wait_for_challenge_completion(page, timeout=180):
                        ...
                        print("⚠️  Still waiting - please complete verification manually")
                        try:
                ...
                if not repo_found:
                    print(f"⚠️  Could not find repository '{self.repo_name}' automatically")
