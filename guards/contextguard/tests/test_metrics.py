...
class TestMetricsEndpoint:
    ...
    def test_metrics_contains_request_duration(self):
        ...
        # Assert
        assert response.status_code == 200
        assert "contextguard_request_duration_seconds" in response.text
    ...
    def test_metrics_contains_redis_status(self):
        ...
        # Assert
        assert response.status_code == 200
        assert "contextguard_redis_connection_status" in response.text
    ...
    def test_metrics_contains_memory_operations(self):
        ...
        # Assert
        assert response.status_code == 200
        assert "contextguard_memory_operations_total" in response.text
