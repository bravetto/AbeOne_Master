...
def REPLACE_ME(base_url: str, webhook_secret: str = "REPLACE_ME"):
...
def main():
    ...
    parser.add_argument('--stripe-secret', default='REPLACE_ME', help='Stripe webhook secret for testing')
    parser.add_argument('--clerk-secret', default='REPLACE_ME', help='Clerk webhook secret for testing')
    ...
    if not args.skip_webhooks:
        ...
        REPLACE_ME(args.base_url, args.stripe_secret)
        print()
        REPLACE_ME(args.base_url, args.clerk_secret)
        print()
