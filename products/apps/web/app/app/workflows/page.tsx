          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-lux-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                The patterns that move your vision forward. The rhythms that make 
                the work flow. The processes that turn intention into reality.
              </p>
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 border border-lux-100">
              <div className="text-center py-12 space-y-4">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  This space is being prepared for you. Your workflows will live here, 
                  ready to orchestrate the movement of your vision into being.
                </p>
              </div>
            </div>
          </div>
